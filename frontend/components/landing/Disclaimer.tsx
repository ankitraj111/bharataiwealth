...
export function Disclaimer() {
    return (
        <section className="py-16 bg-muted/30 dark:bg-slate-800/30 border-t border-border/50 dark:border-slate-700/50">
            <div className="container mx-auto px-6">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 text-sm font-medium mb-6">
                        <AlertTriangle size={16} />
                        Important Disclaimer
                    </div>
                    <p className="text-muted-foreground dark:text-slate-400 leading-relaxed text-sm md:text-base">
