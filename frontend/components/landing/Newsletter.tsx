...
export function Newsletter() {
    ...
    return (
        <section className="py-24 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full opacity-10 bg-[radial-gradient(circle_at_20%_30%,#818cf8,transparent_50%),radial-gradient(circle_at_80%_70%,#c084fc,transparent_50%)]" />

            <div className="container mx-auto px-6 relative z-10">
                <div className="max-w-5xl mx-auto rounded-[3rem] p-8 md:p-16 border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            <motion.div
                                ...
                                viewport={{ once: true }}
                            >
                                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/20 text-primary-foreground border border-primary/30 text-sm font-bold mb-6">
                                    <Sparkles className="w-4 h-4" />
                                    Bharat Wealth Insights
                                </span>
                                <h2 className="text-4xl md:text-5xl font-black text-white leading-tight">
                                    Master Your Money with <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent italic">AI-Powered</span> Insights
                                </h2>
                        ...
                        >
                            ...
                            <div className="relative p-1 rounded-3xl bg-slate-800/50 border border-white/10 backdrop-blur-xl">
                                {subscribed ? (
                                    <motion.div
                                    ...
                                    <form onSubmit={handleSubscribe} className="p-8 space-y-6">
                                        <div className="space-y-4">
                                            <div className="relative">
                                                ...
                                                <Input
                                                    ...
                                                    className="pl-12 h-14 bg-slate-900/50 border-white/10 text-white placeholder:text-slate-500 focus:border-primary/50 text-lg transition-all rounded-xl"
                                                />
                                            </div>
                                            <Button
                                                type="submit"
                                                className="w-full h-14 text-lg font-bold group rounded-xl bg-gradient-to-r from-primary to-indigo-600 hover:shadow-lg hover:shadow-primary/20 transition-all border-none"
                                            >
                                                Start My Progress
                                        ...
                                        <p className="text-center text-xs text-slate-400">
                                            ...
                                            <br />
                                            <span className="text-slate-500 italic mt-1 block">Unsubscribe at any time with one click.</span>
                                        </p>
                                    </form>
                                )}
                            </div>
                            ...
                            <div className="flex items-center justify-around mt-8 opacity-60">
                                <div className="text-center">
                                    <p className="text-xl font-bold text-white tabular-nums">50k+</p>
                                    <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">Subscribers</p>
                                </div>
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">Years of Data</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
